...
<div class="min-h-full flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
	<div class="max-w-md w-full space-y-8">
		<div>
			<h2 class="mt-6 text-center text-3xl font-extrabold text-dark-blue">
				Sign in to your account
			</h2>
			<p class="mt-2 text-center text-sm text-grayish-blue">
				Or
				<a href="/auth/signup" class="font-medium text-moderate-blue"> create an account </a>
			</p>
		</div>
			...
			<div class="flex items-center justify-between">
				<div class="text-sm">
					<button
						...
						class="font-medium text-moderate-blue"
					>
